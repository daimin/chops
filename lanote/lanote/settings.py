...
SECRET_KEY = '*=32vovros%c&amp;5xs(hk&amp;u#5qljv!n!axl75s7mv_-i*if^=hs^'
...
ROOT_URLCONF = 'lanote.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'lanote.wsgi.application'
